...
namespace EPE.Application.Core.DateTimeHelper
{
    public class FarsiDate
    {
        ...
        public string fulDate(string strDate)
        {
            ...
            if (length)
            {
                if (string.IsNullOrWhiteSpace(strArrays[0]) || string.IsNullOrWhiteSpace(strArrays[1]))
                {
                    flag = false;
                }
                else
                {
                    flag = !string.IsNullOrWhiteSpace(strArrays[2]);
                }
                length = flag;
                if (length)
                {
        ...
        public bool isfulDate(string strDate)
        {
            ...
            if (length1)
            {
                ...
                {
                    flag1 = !string.IsNullOrWhiteSpace(strArrays[2]);
                }
                length1 = flag1;
                if (length1)
                {
        ...
        {
            bool flag = string.IsNullOrWhiteSpace(strDate);
            if (flag)
            {
