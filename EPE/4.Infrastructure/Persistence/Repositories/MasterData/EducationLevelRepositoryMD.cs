...
{
    public class EducationLevelRepositoryMD : Repository<EducationLevelMD, int>, IEducationLevelRepositoryMD
    {
        #region members
        ...
        #region constractors
        public EducationLevelRepositoryMD(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
